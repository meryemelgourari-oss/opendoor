                ...
                <div class="bg-white dark:bg-slate-900 p-5 rounded-[2rem] border border-slate-100 dark:border-slate-800 shadow-sm flex items-center justify-between group hover:border-rose-500/30 transition-all">
                    <div class="flex items-center gap-4">
                        ...
                        <div>
                            ...
                            <p class="text-xl font-black text-slate-900 dark:text-white"><?php echo e($countUrgente); ?></p>
                        </div>
                    </div>
                </div>
                ...
                <div class="bg-white dark:bg-slate-900 p-5 rounded-[2rem] border border-slate-100 dark:border-slate-800 shadow-sm flex items-center justify-between group hover:border-blue-500/30 transition-all">
                    <div class="flex items-center gap-4">
                        ...
                        <div>
                            ...
                            <p class="text-xl font-black text-slate-900 dark:text-white"><?php echo e($countNormale); ?></p>
                        </div>
                    </div>
                </div>
                ...
                <div class="bg-white dark:bg-slate-900 p-5 rounded-[2rem] border border-slate-100 dark:border-slate-800 shadow-sm flex items-center justify-between group hover:border-emerald-500/30 transition-all">
                    <div class="flex items-center gap-4">
                        ...
                        <div>
                            ...
                            <p class="text-xl font-black text-slate-900 dark:text-white"><?php echo e($countBasse); ?></p>
                        </div>
                    </div>
                </div>
            </div>
                        ...
                        <tbody class="divide-y divide-slate-50 dark:divide-slate-800">
                            <?php $__empty_1 = true; $__currentLoopData = $reclamations; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $reclamation): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); $__empty_1 = false; ?>
                                ...
                                <tr class="hover:bg-slate-50/30 dark:hover:bg-slate-800/30 transition-colors group">
                                    <td class="px-8 py-6">
                                        <p class="text-sm font-bold text-slate-900 dark:text-white mb-1 uppercase tracking-tight"><?php echo e($reclamation->sujet ?? $reclamation->subject ?? 'Sans sujet'); ?></p>
                                        <p class="text-xs text-slate-500 line-clamp-1 italic"><?php echo e($reclamation->description ?? $reclamation->message); ?></p>
                                    </td>

                                    <td class="px-6 py-6 text-center">
                                        <span class="px-3 py-1 rounded-lg text-[9px] font-black uppercase tracking-widest border
                                            <?php echo e(in_array($prio, ['urgente', 'urgent']) ? 'bg-rose-50 text-rose-600 border-rose-100' : 
                                    ...
                                    <td class="px-6 py-6 text-center">
                                        <span class="px-4 py-1 rounded-full text-[9px] font-black uppercase tracking-widest border flex items-center justify-center gap-2 mx-auto max-w-fit
                                            <?php echo e(in_array($stat, ['resolu', 'resolved', 'success']) ? 'bg-emerald-50 text-emerald-600 border-emerald-200' : 
                                            ...
                                            <span class="size-1.5 rounded-full <?php echo e(in_array($stat, ['resolu', 'resolved']) ? 'bg-emerald-500' : (in_array($stat, ['en_cours', 'pending']) ? 'bg-amber-500' : 'bg-slate-400')); ?>"></span>
                                            <?php echo e($stat); ?>
                                    ...
                                    <td class="px-8 py-6 text-right">
                                        <form action="<?php echo e(route('reclamations.destroy', $reclamation->id)); ?>" method="POST" onsubmit="return confirm('Supprimer définitivement ?')">
...
<?php /**PATH C:\Users\HP\Desktop\opendoor v-final\opendoor\resources\views/properties/user/dashboard/partials/reclamations.blade.php ENDPATH**/ ?>