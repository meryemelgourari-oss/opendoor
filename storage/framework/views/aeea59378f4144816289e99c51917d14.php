        ...
        <div class="max-w-[1600px] mx-auto px-4 sm:px-6 lg:px-8">
            ...
            <div class="grid grid-cols-1 md:grid-cols-3 gap-6 mb-10">
                <div class="bg-white dark:bg-slate-900 p-6 rounded-[2rem] border-b-4 border-blue-500 shadow-sm flex items-center justify-between hover:scale-[1.02] transition-transform">
                    <div>
                        ...
                        <span class="text-3xl font-black text-slate-900 dark:text-white"><?php echo e($stats['total']); ?></span>
                    </div>
                ...
                <div class="bg-white dark:bg-slate-900 p-6 rounded-[2rem] border-b-4 border-emerald-500 shadow-sm flex items-center justify-between hover:scale-[1.02] transition-transform">
                    <div>
                        ...
                        <span class="text-3xl font-black text-emerald-500"><?php echo e($stats['approved']); ?></span>
                    </div>
                ...
                <div class="bg-white dark:bg-slate-900 p-6 rounded-[2rem] border-b-4 border-amber-500 shadow-sm flex items-center justify-between hover:scale-[1.02] transition-transform">
                    <div>
                        ...
                        <span class="text-3xl font-black text-amber-500"><?php echo e($stats['pending']); ?></span>
                    </div>
            ...
            <div class="flex gap-2 mb-8 bg-slate-200/50 dark:bg-slate-800/50 p-1.5 rounded-2xl w-fit backdrop-blur-sm border border-white/20">
                <a href="<?php echo e(route('dashboard.comments')); ?>"
                    class="px-6 py-2 rounded-xl text-[10px] font-black uppercase transition-all <?php echo e(!request('filter') ? 'bg-white dark:bg-slate-700 text-slate-900 dark:text-white shadow-sm' : 'text-slate-500 hover:text-slate-700'); ?>">Tous</a>

                <a href="<?php echo e(route('dashboard.comments', ['filter' => 'pending'])); ?>"
                    class="px-6 py-2 rounded-xl text-[10px] font-black uppercase transition-all <?php echo e(request('filter') == 'pending' ? 'bg-amber-500 text-white shadow-lg shadow-amber-500/20' : 'text-slate-500 hover:text-slate-700'); ?>">En attente</a>

                <a href="<?php echo e(route('dashboard.comments', ['filter' => 'approved'])); ?>"
                    class="px-6 py-2 rounded-xl text-[10px] font-black uppercase transition-all <?php echo e(request('filter') == 'approved' ? 'bg-emerald-500 text-white shadow-lg shadow-emerald-500/20' : 'text-slate-500 hover:text-slate-700'); ?>">Approuvés</a>
            </div>
            ...
            <div class="grid grid-cols-1 lg:grid-cols-12 gap-8">
                ...
                <div class="lg:col-span-2 space-y-4">
                    ...
                    <div class="space-y-3">
                        <?php $__currentLoopData = $propertiesWithStats; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $prop): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                        <div class="bg-white dark:bg-slate-900 p-4 rounded-2xl border border-slate-100 dark:border-slate-800 shadow-sm hover:border-primary/30 transition-all">
                            <p class="text-[9px] font-black uppercase truncate text-slate-500 mb-2"><?php echo e($prop->title); ?></p>
                            <div class="flex justify-between items-center">
                                <span class="text-[10px] font-bold text-slate-400"><?php echo e($prop->commentaires_count); ?> avis</span>
                                <span class="text-[9px] bg-emerald-50 dark:bg-emerald-900/20 text-emerald-600 px-2 py-0.5 rounded-md font-black italic"><?php echo e($prop->approved_count); ?> OK</span>
                            </div>
                        </div>
                ...
                <div class="lg:col-span-10 space-y-6">
                    ...
                    <div class="bg-white dark:bg-slate-900 rounded-[2rem] border border-slate-100 dark:border-slate-800 shadow-sm group hover:shadow-md transition-all duration-300">
                        <div class="p-4 md:p-5 flex flex-col lg:flex-row items-center gap-6"> 
                            ...
                            <div class="flex lg:flex-col items-center gap-3 lg:w-24 flex-shrink-0 lg:border-r border-slate-100 dark:border-slate-800 lg:pr-6">
                                ...
                                <div class="text-left lg:text-center">
                                    ...
                                    <span class="text-[8px] font-bold text-slate-400 block tracking-tighter italic"><?php echo e($comment->created_at->diffForHumans()); ?></span>
                                </div>
                            </div>
                            ...
                            <div class="flex-1 min-w-1 ">
                                <div class="mb-2"> 
                                    <span class="px-3 py-1 bg-blue-50 dark:bg-blue-900/20 text-blue-600 dark:text-blue-400 text-[9px] font-black uppercase rounded-full border border-blue-100 dark:border-blue-800/50 inline-flex items-center gap-1.5">
                                        ...
                                        <?php echo e($comment->property->title); ?>
                            ...
                            <div class=" ml-5 flex flex-row lg:flex-col gap-2 flex-shrink-0 justify-center items-center lg:pl-6 lg:border-l border-slate-100 dark:border-slate-800">
                                ...
                                <form action="<?php echo e(route('comments.approve', $comment->id)); ?>" method="POST" class="w-full lg:w-auto">
                                ...
                                <form action="<?php echo e(route('comments.destroy', $comment->id)); ?>" method="POST" onsubmit="return confirm('Supprimer ?')" class="w-full lg:w-auto">
    ...
    </div><?php /**PATH C:\Users\HP\Desktop\opendoor v-final\opendoor\resources\views/properties/user/dashboard/partials/comments.blade.php ENDPATH**/ ?>