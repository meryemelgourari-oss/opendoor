...
<?php $component->withAttributes([]); ?>
    ...
    <main class="max-w-7xl mx-auto px-6 py-10 lg:py-16" x-data="propertyEditor()">
        <form action="<?php echo e(route('properties.update', $property->id)); ?>" method="POST" enctype="multipart/form-data">
            <?php echo csrf_field(); ?>
...
<?php endif; ?><?php /**PATH C:\Users\HP\Desktop\opendoor v-final\opendoor\resources\views/properties/user/actions/edit.blade.php ENDPATH**/ ?>