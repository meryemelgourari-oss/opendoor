            ...
            <div class="grid grid-cols-1 md:grid-cols-3 gap-6">
                ...
                <div class="group bg-white border border-slate-200 p-8 rounded-[2.5rem] shadow-sm transition-all duration-300 hover:shadow-xl hover:-translate-y-1">
                    ...
                    <h2 class="text-3xl font-black text-slate-900 mt-1">
                        <?php echo e(number_format($stats['avg_price'], 0, ',', ' ')); ?> <span class="text-sm text-blue-600 font-medium">DH</span>
                    </h2>
                </div>
                ...
                <div class="group bg-white border border-slate-200 p-8 rounded-[2.5rem] shadow-sm transition-all duration-300 hover:shadow-xl hover:-translate-y-1">
                    ...
                    <h2 class="text-3xl font-black text-slate-900 mt-1">
                        <?php echo e($stats['total_listings']); ?> <span class="text-sm text-blue-600 font-medium">Unités</span>
                    </h2>
                </div>
                    ...
                    <div class="relative z-10 h-full flex flex-col justify-between">
                        <div>
                            ...
                            <h2 class="text-2xl font-black text-white mt-2 italic truncate">
                                <?php echo e($stats['popular_district']); ?>

                            </h2>
                        </div>
                        <a href="<?php echo e(route('properties.index', ['search' => $stats['popular_district']])); ?>"
...
<?php endif; ?><?php /**PATH C:\Users\HP\Desktop\opendoor v-final\opendoor\resources\views/properties/analytics.blade.php ENDPATH**/ ?>